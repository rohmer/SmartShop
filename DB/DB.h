...
inline auto initCoreStorage(const std::string &path)
{
	...
	return make_storage(path,
		...
		make_table("Software",
			...
			make_column("installTime", &DBInstall::installTime)),
		make_table("Files",
			...
			make_column("major", &DBInstallFile::major),
			make_column("minor", &DBInstallFile::minor),
			make_column("buildNum", &DBInstallFile::buildNum),
			make_column("installTime", &DBInstallFile::installTime)),
		make_table("Devices",
