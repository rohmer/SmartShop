...
#define LV_USE_DRAW_SW  1
    ...
    *Caching has LV_DRAW_SW_SHADOW_CACHE_SIZE^2 RAM cost*/
    #define LV_DRAW_SW_SHADOW_CACHE_SIZE 2048
    ...
    * 0: to disable caching */
     ...
     *0 mean no caching.*/
    #define LV_DRAW_SW_GRADIENT_CACHE_DEF_SIZE 2048
    ...
    #define LV_DRAW_SW_GRADIENT_DITHER 1
        ...
        #define LV_DRAW_SW_GRADIENT_DITHER_ERROR_DIFFUSION 1
    #endif
 ...
 *0: to disable caching*/
#define LV_IMG_CACHE_DEF_SIZE 5*1024*1024
